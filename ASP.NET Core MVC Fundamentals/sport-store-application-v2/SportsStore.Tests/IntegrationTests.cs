...
public class IntegrationTests
{
    ...
    public async Task HomeController_Index_ContainsPaginationLinks()
    {
        ...
        Assert.Multiple(() =>
        {
            // Should contain pagination links (since we have 9 products and 4 per page = 3 pages)
    ...
    public async Task HomeController_Index_ProductsAreOrderedByProductId()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            var kayakIndex = content.IndexOf("Kayak", StringComparison.Ordinal);
            var lifejacketIndex = content.IndexOf("Lifejacket", StringComparison.Ordinal);
            var soccerBallIndex = content.IndexOf("Soccer Ball", StringComparison.Ordinal);
            var cornerFlagsIndex = content.IndexOf("Corner Flags", StringComparison.Ordinal);
