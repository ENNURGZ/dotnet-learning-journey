...
public class DependencyInjectionDemoMiddleware
{
    ...
    /// </summary>
    public async Task InvokeAsync(HttpContext context, IScopedService scopedService, ITransientService transientService)
    {
        ValidateContext(context);
        await this.ProcessRequestAsync(context, scopedService, transientService);
    }
    ...
    private async Task ProcessRequestAsync(HttpContext context, IScopedService scopedService, ITransientService transientService)
    {
        ...
        context.Response.Headers.Append("X-DI-Scoped-Instance", scopedService.InstanceId);
        context.Response.Headers.Append("X-DI-Transient-Instance", transientService.InstanceId);
