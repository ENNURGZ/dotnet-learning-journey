...
#pragma warning restore CA1031
    ...
    private async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        // Log Error: "Exception handled: {ExceptionType}, Message: {Message}, Path: {Path}"
        this.logger.LogError(exception, "Exception handled: {ExceptionType}, Message: {Message}, Path: {Path}", 
