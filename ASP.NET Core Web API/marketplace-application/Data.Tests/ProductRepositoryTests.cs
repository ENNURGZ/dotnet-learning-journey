...
public class ProductRepositoryTests
{
    [TestCase(1)]
    [TestCase(2)]
    public async Task GetByIdAsync_WhenValidId_ReturnsProduct(int id)
    {
    ...
    [Test]
    public async Task AddAsync_WhenValidProduct_AddsProductToDatabase()
    {
        await using var context = new TradeMarketDbContext(UnitTestDataHelper.GetUnitTestDbOptions());
    ...
    [Test]
    public async Task DeleteByIdAsync_WhenValidId_DeletesProductFromDatabase()
    {
        await using var context = new TradeMarketDbContext(UnitTestDataHelper.GetUnitTestDbOptions());
    ...
    [Test]
    public async Task Update_WhenValidProduct_UpdatesProductInDatabase()
    {
        await using var context = new TradeMarketDbContext(UnitTestDataHelper.GetUnitTestDbOptions());
    ...
    [Test]
    public async Task GetByIdWithDetailsAsync_WhenValidId_ReturnsProductWithIncludedEntities()
    {
        await using var context = new TradeMarketDbContext(UnitTestDataHelper.GetUnitTestDbOptions());
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(product!.ReceiptDetails, Has.Count.EqualTo(expectedReceiptDetailsCount), message: "GetByIdWithDetailsAsync method doesnt't return included entities");
            Assert.That(product.Category, Is.Not.Null, message: "GetByIdWithDetailsAsync method doesnt't return included entities");
        });
    }

    [Test]
    public async Task GetAllWithDetailsAsync_WhenCalled_ReturnsAllProductsWithIncludedEntities()
    {
        await using var context = new TradeMarketDbContext(UnitTestDataHelper.GetUnitTestDbOptions());
        ...
        Assert.Multiple(() =>
        {
            Debug.Assert(products != null, nameof(products) + " != null");
            ...
            Assert.That(product?.ReceiptDetails!, Has.Count.EqualTo(expectedReceiptDetailsCount), message: "GetAllWithDetailsAsync method doesnt't return included entities");
            Assert.That(product?.Category, Is.Not.Null, message: "GetByIdWithDetailsAsync method doesnt't return included entities");
        });
    }
