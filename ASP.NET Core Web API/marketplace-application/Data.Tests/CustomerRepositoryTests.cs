...
public class CustomerRepositoryTests
{
    [TestCase(1)]
    [TestCase(2)]
    public async Task GetByIdAsync_WhenValidId_ReturnsCustomer(int id)
    {
    ...
    [Test]
    public async Task GetAllAsync_WhenCalled_ReturnsAllCustomers()
    {
        await using var context = new TradeMarketDbContext(UnitTestDataHelper.GetUnitTestDbOptions());
    ...
    [Test]
    public async Task AddAsync_WhenValidCustomer_AddsCustomerToDatabase()
    {
        await using var context = new TradeMarketDbContext(UnitTestDataHelper.GetUnitTestDbOptions());
    ...
    [Test]
    public async Task DeleteByIdAsync_WhenValidId_DeletesCustomerFromDatabase()
    {
        await using var context = new TradeMarketDbContext(UnitTestDataHelper.GetUnitTestDbOptions());
    ...
    [Test]
    public async Task Update_WhenValidCustomer_UpdatesCustomerInDatabase()
    {
        await using var context = new TradeMarketDbContext(UnitTestDataHelper.GetUnitTestDbOptions());
    ...
    [Test]
    public async Task GetByIdWithDetailsAsync_WhenValidId_ReturnsCustomerWithIncludedEntities()
    {
        await using var context = new TradeMarketDbContext(UnitTestDataHelper.GetUnitTestDbOptions());
    ...
    [Test]
    public async Task GetAllWithDetailsAsync_WhenCalled_ReturnsAllCustomersWithIncludedEntities()
    {
        await using var context = new TradeMarketDbContext(UnitTestDataHelper.GetUnitTestDbOptions());
